...
SECRET_KEY = "django-insecure-p0=#om@)+rh0ru2l--p)2&r&lxdjv(-j(%1%uc7li54vd2r@qg"
...
TEMPLATES = [
    {
        ...
        "DIRS": [ BASE_DIR / "instaFollower" / "template"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
CELERY_BEAT_SCHEDULE={
    'scheduled_task':{
        'task':'instaFollower.tasks.update',
        'schedule':600.0,   
    }
}